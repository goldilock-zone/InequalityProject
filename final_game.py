...
class Incentives:
    def __init__(self, x, y, size, speed=0.2):
        self.x = x
        self.y = y
        self.radius = size
...
class Players:
    def __init__(self, x, y, size, speed=0.1, sensing_radius=100):
        self.x = x
        self.y = y
...
class Game:
    def __init__(self, players_density, incentives_density, sensing_radius, screenshot_name = "x"):
        ...
        self.players_manager = PlayersManager(screen_width, screen_height, self.players_density, size=5, speed=1, sensing_radius=self.sensing_radius )
...
if __name__ == "__main__":
    ...
    count = 0
    for p_dens in range(50,200, 5):
        for i_dens in range(500,1500, 50):
            count += 1
            game = Game(players_density = p_dens, incentives_density = i_dens, sensing_radius=10)
            ...
            sample_name = "PIDC" + "plyr_" + str(num_players) + "_" + "inctvs_" + str(num_incentives) + "_"
            ...
            with open('experiment_class.csv', mode='a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([
                    sample_name, 
                    number_of_players, 
            ...
            print(f"Count: {count} Sample Name: {sample_name}")
