...
class Incentives:
    def __init__(self, x, y, size, speed=0.5):
        self.x = x
        self.y = y
        self.radius = size
...
class Players:
    ...
    def move(self, incentives):
        ...
        # Remove eaten incentives and increase player's radius
...
class PlayersManager:
    def __init__(self, screen_width, screen_height, density=100, size=5, speed=1, sensing_radius=10):
        self.screen_width = screen_width
        self.screen_height = screen_height
        self.density = density
        self.size = size * ENTITY_SIZE_FACTOR  # Adjust size based on size factor
...
class Game:
    def __init__(self):
        ...
        self.players_manager = PlayersManager(screen_width, screen_height)
